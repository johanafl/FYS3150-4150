...
public:
    ...
    {   /*
        ...
        */
        ...
        {   // Set default filename if no filename is set.
        ...
        {   // Looping over temperature values.
            ...
            // Resetting temperature specific values.
            total_energy = 0;
...
{   
    ...
    std::string conv_postfix = std::to_string(spin_matrix_dim) + "x" + std::to_string(spin_matrix_dim) + "_maxx_test";
